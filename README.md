...
найти его можно в `actions`:
ищете последний Workflow run, заходите в него и скачиваете файл в артефактах

Программа написана на PyQT и не будет работать на macOS
